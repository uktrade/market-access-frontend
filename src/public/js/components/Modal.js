ma.components.Modal = (function( doc ){
	...
	function Modal(){
		...
		jessie.attachListener( doc, 'keydown', jessie.bind( this.handeKeyDown, this ) );
		jessie.attachListener( this.bg, 'click', jessie.bind( this.handleBgClick, this ) );
	}
	...
	Modal.prototype.trapFocus = function(){
		...
		if( supportsCapturing && supportsContains ){
			...
			doc.addEventListener( 'focus', jessie.bind( this.handleFocus, this ), true );
		}
	};
