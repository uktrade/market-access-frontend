...
const reportUrl = {
	...
	hasAdminAreas: ( reportId ) => `/reports/${ getReportPath( reportId ) }/has-admin-areas/`,
	adminAreas: (reportId) => `/reports/${ getReportPath( reportId ) }/admin-areas/`,
	addAdminArea: ( reportId ) => `/reports/${ getReportPath( reportId ) }/admin-areas/add/`,
	removeAdminArea: ( reportId ) => `/reports/${ getReportPath( reportId ) }/admin-areas/remove/`,
